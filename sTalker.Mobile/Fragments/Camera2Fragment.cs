...
namespace sTalker.Fragments
{
    public class Camera2Fragment : Fragment, View.IOnClickListener
    {
        ...
        public Camera2Fragment(Activity activity, Context context, bool faceFront) :this(activity,context)
        {
            ...
            int textureViewHeight, int maxWidth, int maxHeight, Size aspectRatio)
        {
            ...
            {
                Log.Error("Camera2Fragment", "Couldn't find any suitable preview size");
                return choices[0];
            }
        }
        ...
        public static Camera2Fragment NewInstance(Activity activity, Context context, bool faceFront)
        {
            return new Camera2Fragment(activity, context, faceFront);
        }
        ...
        private void SetUpCameraOutputs(int width, int height)
        {
            ...
            try
            {
                for (var i = 0; i < manager.GetCameraIdList().Length; i++)
                {
                    ...
                    var requiredFacing = faceFront ? Integer.ValueOf((int)LensFacing.Front) : Integer.ValueOf((int)LensFacing.Back);
        ...
        public void OpenCamera(int width, int height)
        {
            ...
            try
            {
                if (!mCameraOpenCloseLock.TryAcquire(9500, TimeUnit.Milliseconds))
                {
